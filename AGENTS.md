...
Follow [Attribution — AI Coding Assistants — The Linux Kernel documentation](.agents/skills/determining-git-commit-messages/SKILL.md#when-no-existing-commit-style-found) for AI tooling disclosure in commit messages.
